...
import { Scale, Building2, FileText, Users, Briefcase, HomeIcon, Phone, Mail, MapPin, Linkedin, Star, Quote, ChevronDown, CheckCircle2, Lightbulb, Gavel, Home as HomeIconLucide, Globe, Heart, ScrollText, Bitcoin, Calculator } from 'lucide-react'
...
const practiceAreas = [
  {
    ...
    description: 'Comprehensive employment law services including employment contracts, workplace disputes, labor law compliance, employee relations, and workplace policy development.',
  },
  {
    icon: Lightbulb,
    title: 'Intellectual Property (IP) Laws',
    description: 'Protection and management of intellectual property rights including trademarks, patents, copyrights, and trade secrets. Expert guidance on IP registration and enforcement.',
  },
  {
    icon: Gavel,
  ...
  {
    icon: Building2,
    title: 'Corporate and Commercial Laws',
  ...
  {
    icon: HomeIconLucide,
    title: 'Conveyancing and Real Estate Laws',
    description: 'Complete conveyancing services including property transfers, title searches, sale agreements, leases, and real estate transactions. Expert handling of land law matters.',
  },
  {
    icon: Globe,
    title: 'Immigration Laws',
    description: 'Comprehensive immigration services including work permits, visas, citizenship applications, and immigration compliance for individuals and corporations.',
  },
  {
    icon: Heart,
    title: 'Family and Children Laws',
    description: 'Sensitive handling of family matters including divorce, custody, adoption, child protection, and matrimonial property disputes with a focus on protecting your interests.',
  },
  {
    icon: ScrollText,
    title: 'Probate and Succession Laws',
    description: 'Expert assistance with estate administration, wills, succession planning, probate applications, and inheritance matters to ensure smooth transfer of assets.',
  },
  {
    icon: Bitcoin,
    title: 'Cryptocurrency and Forex Trading Advisory Services',
    description: 'Specialized legal advisory on cryptocurrency regulations, forex trading compliance, digital asset protection, and blockchain technology legal frameworks.',
  },
  {
    icon: Calculator,
    title: 'Tax Laws and Advisory Services',
    description: 'Comprehensive tax planning and advisory services including tax compliance, dispute resolution with tax authorities, and strategic tax optimization for individuals and businesses.',
  },
]
...
const clients = [
  ...
  "Premier Bank",
  "Bandari DT Sacco",
  "Mzima Springs NWDT Sacco",
  "Kenya Red Cross Society",
  "Medlynks by Connect Afya Medical Centre Limited",
    ...
    <div className="min-h-screen">
      ...
      <section id="clients" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          >
            <CarouselContent>
              {Array.from({ length: Math.ceil(clients.length / 6) }).map((_, slideIndex) => (
                <CarouselItem key={slideIndex}>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6 p-1">
                    {clients.slice(slideIndex * 6, slideIndex * 6 + 6).map((client, index) => (
                      <Card key={index} className="flex items-center justify-center p-6 hover:shadow-lg transition-all duration-300 group">
                        <CardContent className="p-0 text-center">
                          <Building2 className="h-10 w-10 mx-auto mb-3 text-primary/40 group-hover:text-primary transition-colors" />
                          <h3 className="font-semibold text-base text-foreground">{client}</h3>
                        </CardContent>
                      </Card>
                    ))}
                  </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">info@isaaclaw.co.ke</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="h-12 w-12 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
